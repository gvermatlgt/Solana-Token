...
export default function MintTokenButton() {
  ...
  const onMint = async () => {
    ...
    console.log(
      "Data Account Keypair:",
      "1. SolExplorer: ",
      `https://explorer.solana.com/address/${dataAccount.publicKey.toBase58()}?cluster=devnet`,
      "2. SolScan: ",
      `https://solscan.io/address/${dataAccount.publicKey.toBase58()}?cluster=devnet`
    );
    ...
    console.log(
      ...
      "2. SolScan: ",
      `https://solscan.io/address/${mintKeypair.publicKey.toBase58()}?cluster=devnet`
    );
    ...
    try {
      ...
      await minterProgram.methods
        ...
        .rpc();
      console.log(
        "Data account initialized successfully: ",
        "1. SolExplorer: ",
        `https://explorer.solana.com/address/${dataAccount.publicKey.toBase58()}?cluster=devnet`,
        "2. SolScan: ",
        `https://solscan.io/address/${dataAccount.publicKey.toBase58()}?cluster=devnet`
      ...
      if (!tokenAccountInfo.value) {
        ...
        const createATASignature = await sendTransaction(
        ...
        console.log(
          ...
          "1. SolExplorer: ",
          `https://explorer.solana.com/tx/${createATASignature}?cluster=devnet`,
          "2. SolScan: ",
          `https://solscan.io/tx/${createATASignature}?cluster=devnet`
        );
      }
      ...
      console.log(
        `${amount}${tokenSymbol} Tokens Successfully Minted:`,
        "1. SolExplorer: ",
        `https://explorer.solana.com/tx/${mintSignature}?cluster=devnet`,
        "2. SolScan: ",
        `https://solscan.io/tx/${mintSignature}?cluster=devnet`
      );
    } catch (error) {
  ...
  return (
    <VStack>
      ...
      <Box>
        ...
        />
        <label htmlFor="">Amount To mint</label>
        <Input
          id="amountToMint"
          name="amountToMint"
      ...
      <Button colorScheme="blue" onClick={onMint}>
        Mint Token
      </Button>
    </VStack>
  );
